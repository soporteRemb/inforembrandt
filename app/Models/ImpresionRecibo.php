...
class ImpresionRecibo extends Model
{
    ...
    protected $fillable = ['recibo_pago_id', 'tipo', 'numero_reimpresion', 'medio', 'ruta_pdf', 'generado_por', 'generado_en'];
    protected $casts = ['numero_reimpresion' => 'integer', 'generado_en' => 'datetime'];

    public static function tipos(): array { return [self::TIPO_ORIGINAL, self::TIPO_REIMPRESION]; }
    public static function medios(): array { return [self::MEDIO_PDF, self::MEDIO_IMPRESORA]; }
