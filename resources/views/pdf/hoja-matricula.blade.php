...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .codigo-row { width: 100%; border-collapse: collapse; margin-bottom: 2px; }
    .codigo-row td { font-size: 10pt; font-weight: bold; font-style: italic; padding: 1px 0; }
...
<div class="titulo">HOJA DE MATRICULA</div>

{{-- Código GA-F07 --}}
<table class="codigo-row">
    <tr>
        <td><em>Codigo GA-F07</em></td>
        <td style="text-align:center"><em>Versión 0</em></td>
        <td style="text-align:right"><em>Fecha: 16/09/2019</em></td>
    </tr>
</table>
...
<table class="meta-row">
    <tr>
        <td><em>FECHA_MATRICULA: {{ \Carbon\Carbon::parse($fecha)->translatedFormat('d/M/Y') }}</em></td>
        <td style="text-align:center"><em>Folio No. {{ $student->folio ?? '____' }}</em></td>
...
<table class="guardian-table">
    ...
    <tr>
        <td colspan="4" style="padding-top:4px;">
            <em><strong>MATRICULA:</strong> {{ strtoupper($student->parentesco_matricula ?? '*') }}</em>
        </td>
    </tr>
</table>
<hr class="bold">
